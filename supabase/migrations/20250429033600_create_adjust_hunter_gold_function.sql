-- supabase/migrations/<TIMESTAMP>_create_adjust_hunter_gold_function.sql
...
BEGIN
    ...
    VALUES (
        p_hunter_id,
        'gold', -- Assuming 'gold' matches your currency_enum or TEXT type
    ...
    RETURN json_build_object(
        ...
        'newBalance', v_new_balance,
         -- Optionally return partial hunter data if needed by frontend optimistic update sync
        'updatedHunter', jsonb_build_object('gold', v_new_balance)
    );
