-- supabase/migrations/<TIMESTAMP>_update_purchase_item_return_instance_id.sql

-- Recreate the function to return the correct inventory item ID field
...
BEGIN
    ...
    RETURN json_build_object(
        ...
        'inventoryItemId', v_inventory_entry.instance_id -- Use instance_id instead of id
    );
