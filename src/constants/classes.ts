...
export const HUNTER_CLASSES: Record<HunterClass, ClassDefinition> = {
  Healer: {
    name: "Healer",
    description:
      "Specialists in recovery and support magic. They can heal allies and apply buffs.",
    baseStats: {
      strength: 5,
      agility: 8,
      perception: 10,
  ...
  Fighter: {
    name: "Fighter",
    description:
      "Masters of close combat who excel at dealing and taking damage.",
    baseStats: {
      strength: 15,
      agility: 10,
      perception: 8,
  ...
  Mage: {
    name: "Mage",
    description:
      "Controllers of arcane energy who can cast powerful offensive spells.",
    baseStats: {
      strength: 5,
      agility: 8,
      perception: 12,
  ...
  Assassin: {
    name: "Assassin",
    description:
      "Swift and deadly hunters who excel at dealing critical damage.",
    baseStats: {
      strength: 10,
      agility: 17,
      perception: 12,
  ...
  Tanker: {
    name: "Tanker",
    description:
      "Defensive specialists who can absorb massive damage for the team.",
    baseStats: {
      strength: 12,
      agility: 5,
      perception: 8,
