...
export async function POST(
  ...
  console.log(`[API /unlock-skill] Received request for hunter: ${params.hunterId}`);
  ...
  try {
    console.log(`[API /unlock-skill] Calling unlockSkill service for user: ${user.id}, hunter: ${hunterId}, skill: ${skillId}`);
    ...
    return NextResponse.json({ 
      ...
      console.error(`[API /unlock-skill] UNEXPECTED ERROR in route handler:`, error);
