...
export async function POST(
    ...
    console.log(`[API /equip-skill] Received request for hunter: ${params.hunterId}`);
    ...
    try {
        console.log(`[API /equip-skill] Calling equipSkill service for user: ${user.id}, hunter: ${hunterId}, skill: ${skillId}`);
        ...
        console.error(`[API /equip-skill] UNEXPECTED ERROR in route handler:`, error);
