...
export async function POST(
  ...
  try {
    ...
    console.log(
      `API Request: Drop item ${inventoryId} (qty: ${quantity}) for hunter ${hunterId}`,
    );
    ...
    console.log(
      `API Success: Item dropped for hunter ${hunterId}. Updated inventory length: ${result.updatedInventory?.length}`,
    );
    return NextResponse.json({
