...
export default function InventoryPage() {
    ...
    if (
      ...
      if (isValidDrop) {
        if (specificSlotTargetAPI) {
          console.log(
            `Attempting to equip ${draggedItem.name} (ID: ${draggedItem.inventoryId}) into specific slot ${targetSlot} via drag & drop.`,
          );
          ...
          console.log(
            `Attempting to equip ${draggedItem.name} (ID: ${draggedItem.inventoryId}) into default slot ${targetSlot} via drag & drop.`,
          );
  ...
  const handleEquipItemToSlotViaDnD = async (
    ...
    try {
      ...
      console.log(
        `Equip successful via DnD (specific slot ${targetSlot}):`,
        result,
      );
      setEquipment(result.equipment);
                    ...
                    <div className="mt-4 flex flex-wrap gap-4">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          ...
                          setSelectedItem(null); /* Deselect on filter change */
                        }}
                      >
                      ...
                      <Select
                        ...
                        onValueChange={(value) => {
                          ...
                          setSelectedItem(null); /* Deselect on sort change */
                        }}
                      >
                        <SelectTrigger className="w-full sm:w-[180px]">
                      ...
                      <CardContent className="flex flex-wrap gap-2">
                        ...
                        {isSelectedItemEquipped && selectedItem.slot && (
                          <Button
                            ...
                            } // Use the slot from the selected item
                            disabled={
