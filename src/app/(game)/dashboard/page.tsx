...
export default function DashboardPage({}: DashboardPageProps) {
  ...
  if (!loading && hunter) {
    ...
    const expProgressInCurrentLevel = Math.max(
      0,
      currentExp - startExpForCurrentLevel,
    ); // Ensure non-negative
                ...
                {(
                  ...
                  <li key={stat} className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      disabled={
                        !hasStatPoints || statLoading === stat || loading
                      } // Disable if no points, or currently allocating this stat, or general loading
