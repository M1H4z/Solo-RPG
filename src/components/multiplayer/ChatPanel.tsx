...
const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <Card className={cn("w-96 h-64 flex flex-col bg-surface/95 backdrop-blur-sm border-border/50", className)}>
      ...
      <div className="flex items-center border-b border-border/30 bg-surface/50 rounded-t-lg overflow-hidden">
        {channels.map((channel, index) => (
          <button
            ...
            className={cn(
              "px-4 py-2 text-sm font-medium border-r border-border/30 last:border-r-0 relative",
        ...
        <div className="flex items-center gap-1 px-3 py-2 text-xs text-text-secondary">
        ...
        {onMinimize && (
          <button
            onClick={onMinimize}
            className="ml-auto p-2 text-text-secondary hover:text-text-primary rounded-tr-lg"
          >
      ...
      {/* Input Area */}
      <div className="border-t border-border/30 p-2 bg-surface/30">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 bg-background border border-border/50 rounded text-sm focus:outline-none focus:border-accent"
            maxLength={1000}
          ...
          <button
            ...
            className="px-3 py-2 bg-accent text-accent-foreground rounded hover:bg-accent/90 disabled:opacity-50"
          >
